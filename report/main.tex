...
\usepackage{needspace} % ใช้ \needspace กันย่อหน้า/หัวข้อถูกตัดข้ามหน้าแบบดูไม่ดี
...
% ความกว้างจริงของป้าย "(1)" ใช้จัดตำแหน่งรายการแบบ (1)(2)(3) ให้บรรทัดแรกเริ่มพอดีกับ
% \parindent ปัจจุบัน (เท่ากับตำแหน่งข้อความหัวข้อ เช่น "ขอบเขต") โดยไม่มีช่องว่างเกิน
\newlength{\parenlabelwidth}
\settowidth{\parenlabelwidth}{(1)}

% ความกว้างของป้ายย่อยสไตล์ "(2.1)" ใช้กับรายการย่อยซ้อนใน (1)(2)(3) เดิม
\newlength{\subParenLabelWidth}
\settowidth{\subParenLabelWidth}{(2.1)}
...
% กัน pagestyle ของสารบัญตาราง/ภาพ (ต่อ) ค้างข้ามมาที่บทที่ 1 —
% \pagestyle ของ fancyhdr มีผลเริ่มจากหน้าที่ shipout ถัดไปเท่านั้น
% ดังนั้นต้องสั่งซ้ำตรงนี้ให้ชัวร์ก่อนเข้าเนื้อหาบทที่ 1
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\thepage}
...
% ==========================================
% แบบฟอร์มรับรองจากที่ปรึกษา (หน้าสุดท้าย)
% ==========================================
\input{advisor-form}
